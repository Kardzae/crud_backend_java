...
class LibroResourceIT {
    ...
    void createLibro() throws Exception {
        ...
        assertThat(testLibro.getSubtitulo()).isEqualTo(DEFAULT_SUBTITULO);
    }
    ...
    void putExistingLibro() throws Exception {
        ...
        updatedLibro.titulo(UPDATED_TITULO).descripcion(UPDATED_DESCRIPCION).precio(UPDATED_PRECIO).subtitulo(UPDATED_SUBTITULO);
        ...
        assertThat(testLibro.getSubtitulo()).isEqualTo(UPDATED_SUBTITULO);
    }
    ...
    void fullUpdateLibroWithPatch() throws Exception {
        ...
        partialUpdatedLibro.titulo(UPDATED_TITULO).descripcion(UPDATED_DESCRIPCION).precio(UPDATED_PRECIO).subtitulo(UPDATED_SUBTITULO);
